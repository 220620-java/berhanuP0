...
public class CLIAccountOpening {
    public void drawCreatAccountPage(){
        ...
        System.out.println("Account Type:"+objAccountType.AccountTypeName + "| Rate %"+objAccountType.InterestRate);
        System.out.println("___________________________________________________________________________________");
        ...
        {
            objAccount.createAccount(objAccount.aaccounttypeid, openingBalance, ownershiptype, AccountNumber, "Active");
        }
